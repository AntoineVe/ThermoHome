<!-- barre de chargement : http://ajaxload.info/ -->
<html>
	<head>
	...
	<body>
    	<h1>Mise à jour&hellip;</h1>
<!--	    <p style="text-align: center;">{{progjour}} -->
	<br /><br />
		 <img src="data:image/gif;base64,
	R0lGODlh3AATAPQAAP324wArNr3CtqWuppunn7e9srG4r8fKvdfXycPGu9PUxdvay9/dzuPg0K+3
    rbvBtufj0+vn1cnLv/Hs2vPt3M3PwvXv3MXIu8/Qwu3o19XVx8HFuamyqPfx3p+poZWinCH+GkNy
    ...
    scXqrLfu+uuwx05FF0XUbvvtuOeu++689+7778AHL/wJIQAAOwAAAAAAAAAAAA==
